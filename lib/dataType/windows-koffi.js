...
export const LPBYTE = koffi.pointer(koffi.types.byte);
export const LPCOLORREF = DWORD;
export const LPCSTR = koffi.pointer(koffi.types.uint8);
export const LPCWSTR = koffi.pointer(koffi.types.uint16);
export const LPCTSTR = koffi.pointer(koffi.types.uint16);
...
export const PBYTE = koffi.pointer(koffi.types.byte);
